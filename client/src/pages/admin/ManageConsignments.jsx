...
const ManageConsignments = () => {
  ...
  const s = {
    ...
    filterBtn: (active) => ({ padding: '7px 16px', fontSize: '13px', borderRadius: '8px', border: `1px solid ${isDark ? '#3a3b3c' : '#d1d5db'}`, background: active ? (isDark ? GOLD_DARK : GOLD) : (isDark ? '#242526' : '#fff'), color: active ? ON_GOLD : (isDark ? '#e4e6eb' : '#374151'), cursor: 'pointer', fontWeight: '500' }),
    ...
    docImage: { width: '100%', height: '160px', objectFit: 'cover', borderRadius: '8px', border: `1px solid ${isDark ? '#3a3b3c' : '#e5e7eb'}`, background: isDark ? '#18191a' : '#f9fafb' },
    docLabel: { fontSize: '11px', color: isDark ? '#b0b3b8' : '#6b7280', marginBottom: '6px' },
    photoGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(110px, 1fr))', gap: '8px', marginBottom: '18px' },
    photoImg: { width: '100%', height: '80px', objectFit: 'cover', borderRadius: '8px', border: `1px solid ${isDark ? '#3a3b3c' : '#e5e7eb'}` },
    ...
    declineTextarea: { width: '100%', padding: '9px 12px', border: `1px solid ${isDark ? '#3a3b3c' : '#d1d5db'}`, borderRadius: '8px', fontSize: '13px', outline: 'none', boxSizing: 'border-box', minHeight: '70px', resize: 'vertical', marginBottom: '10px', background: isDark ? '#18191a' : '#fff', color: isDark ? '#e4e6eb' : '#111827' },
    reviewedNote: { fontSize: '12px', color: isDark ? '#b0b3b8' : '#6b7280', marginTop: '18px', fontStyle: 'italic' },
