...
const ManageArchivedCars = () => {
  ...
  const s = {
    ...
    card: { display: 'flex', gap: '14px', alignItems: 'center', background: isDark ? '#242526' : '#fff', border: `1px solid ${isDark ? '#3a3b3c' : '#e5e7eb'}`, borderRadius: '12px', padding: '14px 16px', marginBottom: '12px' },
    thumb: { width: '70px', height: '52px', borderRadius: '8px', overflow: 'hidden', background: isDark ? '#3a3b3c' : '#f3f4f6', flexShrink: 0 },
    ...
    archivedDate: { fontSize: '11px', color: isDark ? '#8a8d91' : '#9ca3af', marginTop: '4px' },
