...
const Analytics = () => {
  ...
  const s = {
    ...
    statCard: { background: isDark ? '#242526' : '#fff', border: `1px solid ${isDark ? '#3a3b3c' : '#e5e7eb'}`, borderRadius: '12px', padding: '16px' },
    ...
    empty: { fontSize: '13px', color: isDark ? '#b0b3b8' : '#6b7280' },
    topCarRow: { display: 'flex', alignItems: 'center', gap: '10px', padding: '8px 0', borderBottom: `1px solid ${isDark ? '#3a3b3c' : '#f3f4f6'}` },
    topCarRank: { width: '20px', fontSize: '13px', fontWeight: '700', color: isDark ? '#8a8d91' : '#9ca3af', flexShrink: 0 },
    topCarThumb: { width: '44px', height: '32px', borderRadius: '6px', overflow: 'hidden', background: isDark ? '#3a3b3c' : '#f3f4f6', flexShrink: 0 },
    topCarInfo: { flex: 1, minWidth: 0 },
    topCarName: { fontSize: '13px', fontWeight: '600', color: isDark ? '#e4e6eb' : '#1a1a1a' },
    topCarMeta: { fontSize: '11px', color: isDark ? '#b0b3b8' : '#6b7280' },
    barTrack: { height: '6px', borderRadius: '3px', background: isDark ? '#3a3b3c' : '#f3f4f6', marginTop: '4px', overflow: 'hidden' },
