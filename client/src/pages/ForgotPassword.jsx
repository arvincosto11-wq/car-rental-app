...
const ForgotPassword = () => {
  ...
  const styles = {
    container: {
      ...
      background: isDark ? '#0f172a' : '#f9fafb', padding: '40px 16px',
    },
    card: {
      background: isDark ? '#1e293b' : '#fff', padding: '40px', borderRadius: '12px',
      border: `1px solid ${isDark ? '#334155' : '#e5e7eb'}`, width: '100%', maxWidth: '400px',
    },
    ...
    input: {
      ...
      fontSize: '14px', outline: 'none', boxSizing: 'border-box', background: isDark ? '#0f172a' : '#fff', color: isDark ? '#f1f5f9' : '#111827',
    },
    btn: {
