...
const RateBookings = () => {
  ...
  const styles = {
    ...
    title: { fontSize: '28px', fontWeight: '700', color: isDark ? '#e4e6eb' : '#1a1a1a', marginTop: '10px', marginBottom: '4px' },
    ...
    imgWrap: { width: '90px', height: '64px', borderRadius: '8px', overflow: 'hidden', background: isDark ? '#3a3b3c' : '#f3f4f6', flexShrink: 0 },
    img: { width: '100%', height: '100%', objectFit: 'cover' },
    noImg: { width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', color: isDark ? '#8a8d91' : '#9ca3af' },
    info: { flex: 1 },
    ...
    meta: { fontSize: '12px', color: isDark ? '#b0b3b8' : '#6b7280', marginTop: '4px' },
    rateBtn: {
  ...
  return (
    <div style={styles.container}>
      <BackButton text="Back to My Bookings" onClick={() => navigate('/my-bookings')} />
